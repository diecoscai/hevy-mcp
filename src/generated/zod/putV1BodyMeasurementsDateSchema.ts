...
import { putBodyMeasurementSchema } from "./putBodyMeasurementSchema.js";
import { z } from "zod/v4";

export const putV1BodyMeasurementsDatePathParamsSchema = z.object({
    "date": z.iso.date().describe("The date of the measurement to update (YYYY-MM-DD)")
    })
...
export const putV1BodyMeasurementsDateMutationRequestSchema = z.lazy(() => putBodyMeasurementSchema)

export const putV1BodyMeasurementsDateMutationResponseSchema = z.lazy(() => putV1BodyMeasurementsDate200Schema)