...
"pageSize": z.coerce.number().int().default(10).describe("Number of items per page (Max 10)")
    })
...
export const getV1BodyMeasurementsQueryResponseSchema = z.lazy(() => getV1BodyMeasurements200Schema)