 ...
 */
export const getV1BodyMeasurementsDate200Schema = z.lazy(() => bodyMeasurementSchema)
...
export const getV1BodyMeasurementsDateQueryResponseSchema = z.lazy(() => getV1BodyMeasurementsDate200Schema)